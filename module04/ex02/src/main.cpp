...
int main()
{
        ...
        const AAnimal* pDog = new Dog();
        const AAnimal* pCat = new Cat();
        ...
        const AAnimal* catToCopy = new Cat();
        std::cout << std::endl;
        ...
        const AAnimal* pDog = new Dog(*dogToCopy);
        AAnimal* pCat = new Cat((Cat &)(*catToCopy));
